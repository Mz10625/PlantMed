...
import 'display_plant_data.dart';
                ...
                case ObjectDetector:
                  ...
                  return StreamBuilder(
                    ...
                    builder: (
                      ...
                      /// Modifications ...
                      for (final detectedObject in (snapshot.data! as List<DetectedObject>)) {
                        if (detectedObject.confidence >= 0.9) {
                          // print(detectedObject.label);
                          // print(detectedObject.confidence);
                          WidgetsBinding.instance.addPostFrameCallback((_) {
                            Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => RenderPlantData(detectedObject.label)));
                          });
                        }
                      }
                      // ///
