...
// import 'feedback_bottom_sheet_widget.dart';
                      ...
                      children: [
                        Builder(
                          builder: (context) => InkWell(
                            ...
                            onTap: () async {
                              // logFirebaseEvent('MEAL_BOTTOM_SHEET_ShareMealTile_ON_TAP');
                              // logFirebaseEvent('ShareMealTile_share');
                              // await Share.share('Check out this amazing recipe for ${widget.mealRef?.mealName}! Here are the ingredients: ${widget.mealRef?.mealIngredients}',
                        ...
                        InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            // logFirebaseEvent('MEAL_BOTTOM_SHEET_SendFeedbackTile_ON_TA');
